...
static const uint32_t pwm_period = 84000000/25000; // 25000
...
void motordriver_set2(uint32_t i, int32_t m_delay, float damper)
{
    ...
    pwm2_pulse_width_1 = (uint32_t)(damper * pwm_period * 0.5f*(1.0f+sinf((2.0f*M_PI)*((float)i/(float)m_delay))));
    pwm2_pulse_width_2 = (uint32_t)(damper * pwm_period * 0.5f*(1.0f+sinf((2.0f*M_PI)*((float)j/(float)m_delay))));
    pwm2_pulse_width_3 = (uint32_t)(damper * pwm_period * 0.5f*(1.0f+sinf((2.0f*M_PI)*((float)k/(float)m_delay))));
}
//uint8_t flag = 0;
